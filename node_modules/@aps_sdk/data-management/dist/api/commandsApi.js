...
const CommandsApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        executeCommand: (accessToken_1, projectId_1, xUserId_1, commandPayload_1, ...args_1) => __awaiter(this, [accessToken_1, projectId_1, xUserId_1, commandPayload_1, ...args_1], void 0, function* (accessToken, projectId, xUserId, commandPayload, options = {}) {
            // verify required parameter 'projectId' is not null or undefined
            (0, common_1.assertParamExists)('executeCommand', 'projectId', projectId);
...
const CommandsApiFp = function (sdkManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        executeCommand(accessToken, projectId, xUserId, commandPayload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.executeCommand(accessToken, projectId, xUserId, commandPayload, options);
...
class CommandsApi extends base_1.BaseApi {
    ...
    executeCommand(accessToken, projectId, xUserId, commandPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.CommandsApiFp)(this.sdkManager).executeCommand(accessToken, projectId, xUserId, commandPayload, options);
                ...
                if (error.response) {
                    ...
                    throw new base_1.DataManagementApiError(`executeCommand Request failed with status : ${error.response.status} and error message: ${errorMessage}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`executeCommand Request failed with no response received: ${error.request}`);
                    throw new base_1.DataManagementApiError(`executeCommand Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
