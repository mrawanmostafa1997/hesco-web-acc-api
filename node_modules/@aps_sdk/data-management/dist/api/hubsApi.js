...
const HubsApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        getHub: (accessToken_1, hubId_1, xUserId_1, ...args_1) => __awaiter(this, [accessToken_1, hubId_1, xUserId_1, ...args_1], void 0, function* (accessToken, hubId, xUserId, options = {}) {
         ...
         * @throws {RequiredError}
         */
        getHubs: (accessToken_1, xUserId_1, filterId_1, filterName_1, filterExtensionType_1, ...args_1) => __awaiter(this, [accessToken_1, xUserId_1, filterId_1, filterName_1, filterExtensionType_1, ...args_1], void 0, function* (accessToken, xUserId, filterId, filterName, filterExtensionType, options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.response) {
                    ...
                    throw new base_1.DataManagementApiError(`getHub Request failed with status : ${error.response.status} and error message: ${errorMessage}`, error);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.response) {
                    ...
                    throw new base_1.DataManagementApiError(`getHubs Request failed with status : ${error.response.status} and error message: ${errorMessage}`, error);
                }
                else if (error.request) {
