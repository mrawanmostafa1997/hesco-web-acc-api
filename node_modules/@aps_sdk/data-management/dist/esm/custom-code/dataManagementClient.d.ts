...
import { CheckPermission, CheckPermissionPayload, PublishModelJobPayload, CreatedItem, FilterDirection, FilterRefType, FilterTypeVersion, Folder, Item, ItemPayload, ItemTip, ListItems, ListItemsPayload, ListRefs, ListRefsPayload, ModifyItemPayload, Refs, RelationshipLinks, RelationshipRefs, RelationshipRefsPayload, Versions, PublishWithoutLinksPayload, PublishWithoutLinks, PublishModel, PublishModelPayload } from "../model";
export declare class DataManagementClient extends BaseClient {
     ...
     */
    getHub(hubId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
     ...
     */
    createDownload(projectId: string, downloadPayload: DownloadPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof ProjectsApi
     */
    createStorage(projectId: string, storagePayload: StoragePayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Storage>;
     ...
     */
    getDownload(projectId: string, downloadId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Download>;
     ...
     * @throws {RequiredError}
     */
    getDownloadJob(projectId: string, jobId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Job>;
     ...
     * @throws {RequiredError}
     */
    getHubProjects(hubId: string, optionalArgs?: {
        xUserId?: string;
        filterId?: Array<string>;
        filterExtensionType?: Array<string>;
        pageNumber?: number;
     ...
     * @throws {RequiredError}
     */
    getProject(hubId: string, projectId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Project>;
     ...
     * @throws {RequiredError}
     */
    getProjectHub(hubId: string, projectId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Hub>;
     ...
     * @throws {RequiredError}
     */
    getProjectTopFolders(hubId: string, projectId: string, optionalArgs?: {
        xUserId?: string;
     ...
     * @throws {RequiredError}
     */
    getFolder(projectId: string, folderId: string, optionalArgs?: {
     ...
     * @throws {RequiredError}
     */
    createFolder(projectId: string, folderPayload: FolderPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Folder>;
     ...
     * @throws {RequiredError}
     */
    createFolderRelationshipsRef(folderId: string, projectId: string, relationshipRefsPayload: RelationshipRefsPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Response>;
     ...
     * @throws {RequiredError}
     */
    getFolderContents(projectId: string, folderId: string, optionalArgs?: {
        xUserId?: string;
     ...
     * @throws {RequiredError}
     */
    getFolderParent(projectId: string, folderId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Folder>;
     ...
     * @throws {RequiredError}
     */
    getFolderRefs(projectId: string, folderId: string, optionalArgs?: {
        xUserId?: string;
        filterType?: Array<FilterTypeVersion>;
        filterId?: Array<string>;
        filterExtensionType?: Array<string>;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @throws {RequiredError}
     */
    getFolderRelationshipsLinks(projectId: string, folderId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @throws {RequiredError}
     */
    getFolderRelationshipsRefs(folderId: string, projectId: string, optionalArgs?: {
        xUserId?: string;
        filterType?: Array<FilterTypeVersion>;
        filterId?: Array<string>;
     ...
     * @throws {RequiredError}
     */
    getFolderSearch(projectId: string, folderId: string, optionalArgs?: {
     ...
     * @throws {RequiredError}
     */
    patchFolder(projectId: string, folderId: string, modifyFolderPayload: ModifyFolderPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Folder>;
     ...
     * @throws {RequiredError}
     */
    getVersion(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Version>;
     ...
     * @throws {RequiredError}
     */
    getVersionDownloadFormats(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @throws {RequiredError}
     */
    getVersionDownloads(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
     ...
     * @throws {RequiredError}
     */
    getVersionItem(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Item>;
     ...
     * @throws {RequiredError}
     */
    getVersionRefs(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
        filterType?: Array<FilterTypeVersion>;
        filterId?: Array<string>;
        filterExtensionType?: Array<string>;
     ...
     * @throws {RequiredError}
     */
    getVersionRelationshipsLinks(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<RelationshipLinks>;
     ...
     * @throws {RequiredError}
     */
    getVersionRelationshipsRefs(projectId: string, versionId: string, optionalArgs?: {
        xUserId?: string;
        filterType?: Array<FilterTypeVersion>;
        filterId?: Array<string>;
        filterRefType?: FilterRefType;
     ...
     * @throws {RequiredError}
     */
    patchVersion(projectId: string, versionId: string, modifyVersionPayload: ModifyVersionPayload, optionalArgs?: {
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Version>;
    /**
     ...
     */
    createVersion(projectId: string, versionPayload: VersionPayload, optionalArgs?: {
        xUserId?: string;
        copyFrom?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @throws {RequiredError}
     */
    createVersionRelationshipsRef(projectId: string, versionId: string, relationshipRefsPayload: RelationshipRefsPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Version>;
    ...
    */
    createItem(projectId: string, itemPayload: ItemPayload, optionalArgs?: {
        copyFrom?: string;
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof ItemsApiInterface
     */
    createItemRelationshipsRef(projectId: string, itemId: string, relationshipRefsPayload: RelationshipRefsPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
     ...
     * @memberof ItemsApiInterface
     */
    getItem(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
     ...
     * @memberof ItemsApiInterface
     */
    getItemParentFolder(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Folder>;
     ...
     * @memberof ItemsApiInterface
     */
    getItemRefs(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
        filterType?: Array<FilterTypeVersion>;
        filterId?: Array<string>;
        filterExtensionType?: Array<string>;
     ...
     * @memberof ItemsApiInterface
     */
    getItemRelationshipsLinks(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<RelationshipLinks>;
     ...
     * @memberof ItemsApiInterface
     */
    getItemRelationshipsRefs(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
        filterType?: Array<FilterTypeVersion>;
        filterId?: Array<string>;
        filterRefType?: FilterRefType;
     ...
     * @memberof ItemsApiInterface
     */
    getItemTip(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ItemTip>;
     ...
     * @memberof ItemsApiInterface
     */
    getItemVersions(projectId: string, itemId: string, optionalArgs?: {
        xUserId?: string;
        filterId?: Array<string>;
        filterExtensionType?: Array<string>;
     ...
     * @memberof ItemsApiInterface
     */
    patchItem(projectId: string, itemId: string, modifyItemPayload: ModifyItemPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Item>;
     ...
     */
    executeCheckPermissionCommand(projectId: string, checkPermissionPayload: CheckPermissionPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof CommandsApiInterface
     */
    executeListItemsCommand(projectId: string, listItemsPayload: ListItemsPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ListItems>;
     ...
     * @memberof CommandsApiInterface
     */
    executeListRefsCommand(projectId: string, listRefsPayload: ListRefsPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ListRefs>;
     ...
     * @memberof CommandsApiInterface
     */
    executeGetPublishModelJobCommand(projectId: string, PublishModelJobPayload: PublishModelJobPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof CommandsApiInterface
     */
    executePublishModelCommand(projectId: string, publishModelPayload: PublishModelPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<PublishModel>;
     ...
     * @memberof CommandsApiInterface
     */
    executePublishWithoutLinksCommand(projectId: string, publishWithoutLinksPayload: PublishWithoutLinksPayload, optionalArgs?: {
        xUserId?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
